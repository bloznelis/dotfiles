;;; lukas-solarized-light.el -*- lexical-binding: t; -*-
...
(defgroup lukas-solarized-light-theme nil
  "Options for the `lukas-solarized-light' theme."
  :group 'doom-themes)

(defcustom lukas-solarized-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'lukas-solarized-light-theme
  :type 'boolean)

(defcustom lukas-solarized-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'lukas-solarized-light-theme
  :type 'boolean)

(defcustom lukas-solarized-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme lukas-solarized-light
  ...
  ((bg         '("#FDF6E3" "#FDF6E3" "white"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if lukas-solarized-light-brighter-comments
 ...
 ;;  (shadow teal)
   ...
   ;; custom categories
   (-modeline-bright lukas-solarized-light-brighter-modeline)
   (-modeline-pad
    (when lukas-solarized-light-padded-modeline
      (if (integerp lukas-solarized-light-padded-modeline) lukas-solarized-light-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if lukas-solarized-light-brighter-comments
...
;;; lukas-solarized-light-theme.el ends here
